...
FILES=[
 ...
 ("canonical_jsonl","data/canonical/steffel-1809.entries.jsonl"),("canonical_iiif_linkage_summary","data/canonical/steffel-1809.iiif-linkage-summary.json"),
 ("canonical_appendices","data/canonical/steffel-1809.appendices.json"),("diachronic_machine_scores","data/research/diachronic_machine_scores.json"),
...
def main():
 ...
 linkage=read_json(ROOT/"data/canonical/steffel-1809.iiif-linkage-summary.json")
 ...
 active_linkage_complete=(linkage.get("active_records")==1965 and linkage.get("active_records_canvas_mapped")==1965 and linkage.get("active_records_without_digital_page")==[] and linkage.get("invalid_digital_pages")==[] and linkage.get("region_targets_generated")==0)
 ...
 print(f"generated release integrity manifest with {len(records)} hashed artifacts -> {OUT.relative_to(ROOT)}; canonical IIIF={'ready' if canonical_iiif_complete else 'incomplete'}; active Canvas linkage={'complete' if active_linkage_complete else 'incomplete'}; Tellechea full gate={'closed' if full_complete else 'open'}")
