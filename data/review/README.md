...
All 85 accepted starts from `RHD-FR-002` now have complete AI-assisted diplomatic article transcriptions in `RHD-DIP-002A` and `RHD-DIP-002B`. Long or structurally difficult articles are retained with explicit uncertainty notes and remain pending independent human/philological and linguistic verification.

Cumulative status after the two batches: **200 candidates reviewed, 171 starts accepted, 29 false boundaries rejected, 14 clear headword corrections, 171 complete AI-assisted diplomatic articles, and 2,466 active provisional candidates** out of the 2,495-candidate coverage layer.
