...
`RHD-DIP-003A` supplies complete AI-assisted diplomatic transcriptions for 14 accepted p. 357 articles. `RHD-DIP-003B` adds 23 clearly bounded accepted p. 356 articles; the accepted `Cuviruſi` record is deliberately deferred because its printed cross-reference remains visually ambiguous. Thus 37 of the 89 accepted `RHD-FR-003` starts have a complete diplomatic layer and 52 remain pending.

Cumulative status after the three review batches: **300 candidates reviewed, 260 starts accepted, 40 false boundaries rejected, 47 clear headword corrections, 208 complete AI-assisted diplomatic articles, and 2,455 active provisional candidates** out of the 2,495-candidate coverage layer.
