...
The cumulative layer currently contains **774 complete AI-assisted diplomatic article transcriptions**, exactly matching the 774 accepted starts among all 909 facsimile-reviewed candidates. The current inventory records **352 transcriptions with an explicit uncertainty note**. Ambiguous diacritics, compact letter sequences, unusual printer marks, catchwords and inferential readings are retained or flagged rather than silently normalized.
...
The high-confidence tier and the first three medium-confidence cohorts are complete at the AI-assisted boundary-review and diplomatic-transcription levels. This is not global corpus completion: **810 `medium_machine` candidates remain unreviewed**, 716 `low_machine` candidates remain outside systematic review, and all current diplomatic records remain pending independent human/linguistic validation.
