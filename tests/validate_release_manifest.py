...
if "data/research/diachronic_machine_scores.json" not in paths:
    errors.append("diachronic machine score artifact absent from release manifest")
...
print(
    ...
    f"and 298 documentary-scored diachronic candidates"
)
